...
class ProductsController extends Controller
{
    public function __construct(){
        ...
        $this->middleware('auth')->except('index','getStateAreas','getSubCategories','show');

        $this->middleware('check_user_role:members')->except('index','getStateAreas','getSubCategories','show');
    ...
    //show current user login products only
    public function my_products(Request $request)
    {
        //dapatkan user tgh login
        $user = auth()->user();
